...
for m = nwins:-1:-nwins
for l = -nwins:nwins
    tmanstart = tstart+l*deltaT;
    tmanend = tend+m*deltaT;
    ...
    [dip, puni]=HartigansDipSignifTest(X,1);
    if dip > dip_old
        dip_old = dip;
        ...
        %'choice1'
    elseif dip == dip_old && puni < puni_old
        puni_old = puni;
        tstartnew = tstart + l*deltaT;
        tendnew = tend + m*deltaT;
        %'choice2'
    elseif dip == dip_old && puni == puni_old && (tstartnew > tstart + l*deltaT || tendnew < tend + m*deltaT)
        tstartnew = tstart + l*deltaT;
        tendnew = tend + m*deltaT;
        %'choice3'
    end
